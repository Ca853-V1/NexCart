    ...
    return (
        <div className="flex justify-center items-center min-h-[calc(100vh-4rem)]">
            <div className="border-4 border-slate-400 dark:border-slate-700 rounded-xl p-5 bg-white dark:bg-slate-800 shadow-lg dark:shadow-xl dark:shadow-black/40">
                <div className="text-2xl font-bold flex justify-center pb-4">Create Account</div>
                <div className="p-2">
                    <span className="text-xl mr-12 font-bold">Name</span>
                    <input value={name} onChange={(e)=>setName(e.target.value)} className="p-2 rounded-md bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 text-slate-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
                </div>
                <div className="p-2">
                ...
                <div className="p-2">
                    ...
                    <select value={role} onChange={(e)=>setRole(e.target.value)} className="cursor-pointer p-2 rounded-md bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        <option value="customer">Customer</option>
                        <option value="seller">Seller</option>
                    </select>
                </div>
                <div className="p-2">
                    <button onClick={handleSignup} className="px-3 py-1 border-2 border-[#1976D2] text-md text-white font-bold rounded-md cursor-pointer bg-[#1976D2] hover:bg-[#115293]">SIGN UP</button>
                </div>
            </div>
        </div>
    )
